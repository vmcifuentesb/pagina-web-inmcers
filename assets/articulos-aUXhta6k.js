import{u as e}from"./index-eCeRHDJ9.js";var t=e(`calendar`,[[`path`,{d:`M8 2v4`,key:`1cmpym`}],[`path`,{d:`M16 2v4`,key:`4m81vk`}],[`rect`,{width:`18`,height:`18`,x:`3`,y:`4`,rx:`2`,key:`1hopcy`}],[`path`,{d:`M3 10h18`,key:`8toen8`}]]),n=[{id:`tipos-malla-ciclon`,titulo:`Tipos de Malla Ciclón: ¿Cuál elegir para tu proyecto?`,resumen:`Conoce las diferencias entre malla ciclón PVC y galvanizada, y descubre cuál es la mejor opción según tu tipo de proyecto.`,contenido:`La malla ciclón es una de las soluciones de cerramiento más populares en Guatemala. En Inmcers S.A fabricamos dos tipos principales: malla ciclón galvanizada por inmersión en caliente (HG) y malla ciclón con recubrimiento PVC.
...
En Inmcers te asesoramos sin compromiso para que elijas la mejor opción para tu proyecto.`,fecha:`2026-05-15`,categoria:`Productos`,imagen:`/images/fotos/Malla galvanizada (1).jpg`},{id:`mantenimiento-cerramiento`,titulo:`Cómo mantener tu cerramiento perimetral en óptimas condiciones`,resumen:`Consejos prácticos para alargar la vida útil de tu malla ciclón y mantenerla como el primer día.`,contenido:`Un cerramiento perimetral bien mantenido puede durar décadas. Aquí te compartimos consejos prácticos para mantener tu malla ciclón en óptimas condiciones.
...
¿Necesitas asesoría para tu proyecto industrial? Contáctanos y te visitamos para evaluar tu perímetro y recomendarte la mejor solución.`,fecha:`2026-03-10`,categoria:`Seguridad`,imagen:`/images/fotos/Embajada de Brasil8.jpeg`}];export{t as n,n as t};